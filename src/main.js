...
function render() {
    ...
    if (!selectedCategoryId || selectedCategoryId === "null") {
        currentlyViewing.innerHTML = `<strong>Tüm Kategorileri</strong> Görüyorsun`;
    } else {
        const currentCategory = categories.find(
            (category) => category._id === selectedCategoryId
        );
        currentlyViewing.innerHTML = `<strong>${currentCategory.category}</strong> Görüyorsun, Kategoriyi Sil <span>(delete)</span>`;
    }
}
...
function renderCategories() {
  ...
  }" data-category-id="">Tümünü Gör</li>
	`;
...
function renderFormOptions() {
    newTodoSelect.innerHTML += `<option value="">Kategori Seç</option>`;
    editTodoSelect.innerHTML += `<option value="">Kategori Seç</option>`;
